...
var centerMenu = [
    ...
    ,{
        name: '外卖收藏',
        url: '../waimaiCollection/list.html'
    }
    ,{
        name: '外卖订单',
        url: '../waimaiOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '外卖',
        url: './pages/waimai/list.html'
    },

]

var adminurl =  "http://localhost:8080/waimaifuwu/admin/dist/index.html#/login";
