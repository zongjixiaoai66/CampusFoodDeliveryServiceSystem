...
public class WaimaiCollectionView extends WaimaiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String waimaiCollectionValue;
	...
	public WaimaiCollectionView() {

	}

	public WaimaiCollectionView(WaimaiCollectionEntity waimaiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, waimaiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getWaimaiCollectionValue() {
				return waimaiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setWaimaiCollectionValue(String waimaiCollectionValue) {
				this.waimaiCollectionValue = waimaiCollectionValue;
			}
